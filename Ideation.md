...
flowchart RL
 ...
 subgraph ObservabilityLayer["Observability"]
    ...
    style FastAPIGateway fill:#FFF9C4
    style LangGraphOrchestrator fill:#BBDEFB
    style MCPLayer color:#000000,fill:#E1BEE7
    style MemorySystem fill:#757575
    style ObservabilityLayer fill:#FFFFFF
```
